      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <motion.div className="flex-1 relative" whileFocus={{ scale: 1.02 }}>
              <motion.input
                ...
                className="w-full bg-white/5 border-2 border-white/20 rounded-xl px-4 py-3 text-white placeholder:text-white/40 font-mono text-sm focus:outline-none focus:border-[#FF1493] transition-all duration-300"
            ...
            <motion.button
              className="bg-[#FF1493] text-white px-6 py-3 rounded-xl font-bold text-sm tracking-wide whitespace-nowrap relative overflow-hidden"
        ...
        >
          <p className="text-white/60 font-mono text-xs max-w-xl mx-auto leading-relaxed">
            NIVI Energy is a better-for-you energy drink crafted with natural flavors, zero sugar, and a clean energy
                ...
                {section.links.map((item) => (
                  <li key={item}>
                    <motion.div whileHover={{ x: 4 }} transition={{ type: "spring", stiffness: 400, damping: 17 }}>
                      <Link
                        href="#"
                        className="text-white/60 hover:text-[#FF1493] font-mono text-xs transition-colors inline-block"
                      >
                        {item}
                      </Link>
                    </motion.div>
        ...
        >
          ...
          <p className="text-white/40 font-mono text-xs">© 2026 NIVI Energy. All rights reserved.</p>
